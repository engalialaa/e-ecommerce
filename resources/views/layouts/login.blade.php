...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin_public/vendors/css/forms/icheck/icheck.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin_public/vendors/css/forms/icheck/custom.css')}}">
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin_public/css-rtl/pages/login-register.css')}}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
...
<script src="{{asset('admin_public/vendors/js/forms/validation/jqBootstrapValidation.js')}}"
...
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{asset('admin_public/js/scripts/forms/form-login-register.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
