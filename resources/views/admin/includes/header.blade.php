                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        <img class="brand-logo" alt="modern admin logo"
                             src="{{asset('admin_public/images/logo/logo.png')}}">
                        <h3 class="brand-text">{{ auth()->user()->first_name }}  {{ auth()->user()->last_name }}</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  ...
                  src="{{asset('admin_public/images/logo/logo.png')}}" alt="avatar"><i></i></span>
                        </a>
